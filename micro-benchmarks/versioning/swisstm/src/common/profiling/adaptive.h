...
#ifndef WLPDSTM_PROFILING_ADAPTIVE_H_
#define WLPDSTM_PROFILING_ADAPTIVE_H_
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::ThreadInit(STATS *stats_) {
	stats = stats_;
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::StartProfilingTx() {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::EndProfilingTx(uint64_t tx_duration) {
	// update estimates
...
template<class STATS, class STATS_TYPE>
inline uint64_t wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::CalculateEstimate(uint64_t old_value, uint64_t new_value) {
	return (old_value + new_value) >> 1;
}

// TODO: this seems to cost a lot
template<class STATS, class STATS_TYPE>
inline bool wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::ShouldProfile() const {
	return profiling_this_tx;
}

template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::ThreadShutdown() {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxStartStart(int lex_tx_id) {
	StartProfilingTx();
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxStartEnd() {
	if(ShouldProfile()) {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxCommitStart() {
	if(ShouldProfile()) {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxCommitEnd() {
	if(ShouldProfile()) {
		uint64_t commit_end_cycles = get_clock_count();
		uint64_t tx_duration = commit_end_cycles - tx_start_cycles;
		stats->IncrementStatisticsPerTxType(STATS_TYPE::TX_DURATION_ALL, tx_duration);
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::ReadWordStart(Word *addr) {
	if(ShouldProfile()) {
		last_event_cycles = get_clock_count();
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::ReadWordEnd(Word res) {
	if(ShouldProfile()) {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::WriteWordStart(Word *addr, Word val, Word mask) {
	if(ShouldProfile()) {
		last_event_cycles = get_clock_count();
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::WriteWordEnd() {
	if(ShouldProfile()) {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxMallocStart(size_t size) {
	if(ShouldProfile()) {
		last_event_cycles = get_clock_count();
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxMallocEnd(void *ptr) {
	if(ShouldProfile()) {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxFreeStart(void *ptr, size_t size) {
	if(ShouldProfile()) {
		last_event_cycles = get_clock_count();
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxFreeEnd() {
	if(ShouldProfile()) {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxRestartStart() {
	if(ShouldProfile()) {
		last_event_cycles = get_clock_count();
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxRestartEnd() {
	if(ShouldProfile()) {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxAbortStart() {
	if(ShouldProfile()) {
		last_event_cycles = get_clock_count();
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxAbortEnd() {
	if(ShouldProfile()) {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::EstimateProfilingCosts() {
...
template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxStartStartForEstimatingCosts() {
	TxStartStart(PROFILING_COSTS_ESTIMATION_LEXICAL_TX_ID);
}

template<class STATS, class STATS_TYPE>				
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::ReadWordStartForEstimatingCosts() {
	ReadWordStart(NULL);
}

template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::ReadWordEndForEstimatingCosts() {
	ReadWordEnd(0);
}

template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::WriteWordStartForEstimatingCosts() {
	WriteWordStart(NULL, 0);
}

template<class STATS, class STATS_TYPE>				
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxMallocStartForEstimatingCosts() {
	TxMallocStart(0);
}

template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxMallocEndForEstimatingCosts() {
	TxMallocEnd(NULL);
}

template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::TxFreeStartForEstimatingCosts() {
	TxFreeStart(NULL, 0);
}

template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::ThreadStart() {
	// empty
}

template<class STATS, class STATS_TYPE>
inline void wlpdstm::AdaptiveProfiling<STATS, STATS_TYPE>::ThreadEnd() {
	// empty
}
