...
namespace wlpdstm {
	...
	public:
		...
		static const char *GetTypeName(Type type) {
			const char *type_names[] = {
				...
				"AbortWriteWrite",
				"NoFreeNextEpoch",
				"AppThreadCleanupHelp",
				"WaitOnAbort",
				"CheckForConcurrentReader",
				"CheckForConcurrentReaderNoReader",
#ifdef USE_MINIMUM_READER_VERSION
				"CheckForConcurrentReaderMinVersionHit",
#endif /* USE_MINIMUM_READER_VERSION */
#ifdef PERFORMANCE_COUNTING
				"Cycles",
				"RetiredInstructions",
	...
	typedef EpochSTMStats StatisticsType;
